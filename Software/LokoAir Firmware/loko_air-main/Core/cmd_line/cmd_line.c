...
static char const *_cmd_enable_lowaran(const char *string) {
    const char *dig_str = _get_next_sub_num_str(string);
...
static cmd_t _cmd_list[] = {
    ...
    { "enable lorawan mode", _cmd_enable_lowaran,           "Enable or disable LoRaWAN mode. Ex:enable lorawan mode 1"                             },
